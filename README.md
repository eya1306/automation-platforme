...
| **Impact SDDD LLR** | two Word documents | one report with the before and after of each changed section |
...
| **Impact Call Tree** † | two call-tree sheets | a before/after report, removals red, additions green, renames matched |
